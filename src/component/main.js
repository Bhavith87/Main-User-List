...
const MainUser = () => {
  ...
  return (
    <div className="container-fluid py-4 min-vh-100 bg-light position-relative">
      {notification && (
        <div className="notification alert alert-danger position-absolute top-0 end-0 mt-3 me-3">
          {notification}
        </div>
      )}
      ...
      <div className="d-flex justify-content-between mb-3 mt-4">
        ...
        <button className="toggle-button inline-flex items-center gap-2 text-white font-semibold" onClick={() => setShowSubModal(true)}>
          ...
          <div className="subscriber-overlay">
            ...
            >
              ...
              {selectedSubscribers.map((s, index) => (
                <div key={index} className="subscriber-card">{s}</div>
              ))}
            </motion.div>
          </div>
        )}
        ...
        <div className="form-container">
          ...
          <form onSubmit={handleSubmit} className="styled-form">
            <div className="form-group mt-4">
              ...
              <input type="text" className="form-control mt-3" name="referenceId" value={formData.referenceId} disabled />
            </div>
            <div className="form-group mt-4">
              <label><FaUser className="me-2" />Name</label>
              <input type="text" className="form-control mt-3" name="name" value={formData.name} onChange={handleChange} required />
            </div>
            <div className="form-group mt-4">
              <label><FaPhoneAlt className="me-2" />Phone</label>
              <input type="text" className="form-control mt-3" name="phone" value={formData.phone} onChange={handleChange} required />
            </div>
            <div className="form-group mt-4">
